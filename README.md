...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-zabbix_agent/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-zabbix_agent/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-zabbix_agent.svg)](https://github.com/buluma/ansible-role-zabbix_agent/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-zabbix_agent.svg)](https://github.com/buluma/ansible-role-zabbix_agent/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-zabbix_agent.svg)](https://github.com/buluma/ansible-role-zabbix_agent/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/zabbix_agent)](https://galaxy.ansible.com/ui/standalone/roles/buluma/zabbix_agent/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-zabbix_agent/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-zabbix_agent
